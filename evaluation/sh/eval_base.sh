...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}_base_500_samples/math_eval

SPLIT="test"
NUM_TEST_SAMPLE=500

# English open datasets
DATA_NAME="gsm8k,math,svamp,mmlu_stem,asdiv,mawps,carp_en,tabmwp,minerva_math,gaokao2023en,olympiadbench,college_math"
# DATA_NAME="gaokao2023en,olympiadbench,college_math"
